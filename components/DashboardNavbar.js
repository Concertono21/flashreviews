...
const DashboardNavbar = ({
  ...
  <nav className="flex items-center justify-between p-4 max-w-6xl mx-auto sm:w-full">
    {/* Account Button on the Left */}
    <div className="relative flex-grow flex items-center">
      <button
        className="flex items-center space-x-2 bg-transparent text-white border-2 border-[#bafd00] px-4 py-2 rounded-full sm:w-auto"
