const Hero = () => {
  return (
    <section id="home" className="hero bg-black py-20 text-center">
      <div className="hero-content max-w-md mx-auto px-4">
        ...
        <ul className="benefits list-disc mt-4 text-white text-left mx-auto max-w-xs sm:text-xl md:text-2xl">
          <li>Pay once, use forever</li>
          <li>1-minute no-code setup</li>
          <li>Boost customer satisfaction</li>
        </ul>
        <a href="signin.html" className="cta-button text-black px-6 py-3 rounded mt-6 inline-block" style={{ backgroundColor: '#bafd00' }}>
          Get Flash Reviews
        </a>
      </div>
    </section>
